...
<body>
    ...
    <?php
        ...
        require_once "acoes/acoescategoria.php";
    ...
    <div class="container">
        ...
        <h2>Cadastrar de Categorias(Produto)  </h2>

        <form method="post" action="" autocomplete="off">
            <div class="form-group">
                <label for="exampleFormControlInput1">Nome da Categoria</label>
                <input type="text" name="categoria" value="<?=(isset($func["categoria"]) ?  ($func["categoria"]) : ("") )   ?>" class="form-control" id="exampleFormControlInput1" placeholder="Nome">
            </div>
        ...
        <table class="table" style="margin-top: 30px;">
            ...
            <?php
            $contagem = 1;
            foreach($categoria->querySeleciona() as $rst )
            {
                ?>
                <tr>
