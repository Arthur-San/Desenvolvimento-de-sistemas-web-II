            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <form target="pagseguro" method="post" action="https://pagseguro.uol.com.br/checkout/checkout.jhtml">
                        <input type="hidden" name="email_cobranca" value="brianqiescola@gmail.com" />
                        <input type="hidden" name="tipo" value="CBR" />
                        <input type="hidden" name="moeda" value="BRL" />
                        <input type="hidden" name="item_id" value="<?php echo rand(); ?>" />
                        <input type="hidden" name="item_descr" value="<?php echo $rst["nome"] ?>" />
