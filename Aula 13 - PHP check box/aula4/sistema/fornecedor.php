...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <form method="post" action="acoes/cadfornecedor.php" autocomplete="off">
                ...
                <div class="form-group form-check">
                    ...
                    <input type="checkbox" name="linguagens[]" value="PHP"  class="form-check-input" id="exampleCheck1">
                    <label class="form-check-label" for="exampleCheck1">PHP</label>
                    <br>
                    <input type="checkbox" name="linguagens[]" value="Java"  class="form-check-input" id="exampleCheck1">
                ...
                <button type="submit" name="enviar" class="btn btn-primary">Cadastro de Fornecedor</button>
